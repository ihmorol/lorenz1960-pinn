...
- Do not mix complete spellings and abbreviations of units: "Wb/m^2^" or
  "webers per square meter", not "webers/m^2^". Spell out units when
...
B TE-.125emX does not work by magic. It doesn't get the bibliographic
data from thin air but from .bib files. If you use B TE-.125emX to
...
- In American English, commas, semicolons, periods, question and
  ...
  the quotation marks. A parenthetical phrase or statement at the end of
  a sentence is punctuated outside of the closing parenthesis (like
...
+:============:+:=====================:+:=============:+:=============:+
| 2-4 **Head** | ***Table column       | ***Subhead*** | ***Subhead*** |
|              | subhead***            |               |               |
+--------------+-----------------------+---------------+---------------+
| copy         | More table            |               |               |
|              | copy$^{\mathrm{a}}$   |               |               |
...
<img src="./fig1.png" />
<figcaption>Example of a figure caption.</figcaption>
</figure>
