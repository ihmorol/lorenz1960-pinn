...
- `causal-window/candidate-512pt/<architecture>_<settings-hash>/`: the proposed
  lower-cost causal-window configuration in `run_causal.py`.
...
reused. No new training output has been generated by the code repair.
